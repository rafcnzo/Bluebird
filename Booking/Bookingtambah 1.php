...
<body>
  ...
  <script>
    // Function to fetch data from driver and pelanggan files and populate the dropdowns
    function fetchDataAndPopulateDropdowns() {
      // Fetch data for DriverNo dropdown
      fetch('drivertambah.html')
      ...
      // Fetch data for PemesanId dropdown
      fetch('pelanggantambah.html')
        .then(response => response.text())
        .then(data => {
