...
<body>
    <header>
        ...
        <nav>
            ...
            <a href="Pelangganlihat.php">Pelanggan</a>
    ...
    <form>
        ...
        <h4 style="text-align: center; color: #305494; font-size : 20px;" ,>TABEL PELANGGAN</h4>

        <div class="content-actions">
            <a href="Pelanggantambah.php">Tambah Pelanggan</a>
        ...
        <table border="1" align="center" width="100%">
            ...
            <tr>
                ...
                <td><?php echo $data['No_telepon_pemesan']; ?></td>
                <td><?php echo $data['Email_pemesan']; ?></td>
                <td>
                    <a class="edit" href="Pelangganedit.php?Id_pemesan=<?php echo $data['Id_pemesan']; ?>">Edit</a> |
                    <a class="hapus" href="Pelangganhapus.php?Id_pemesan=<?php echo $data['Id_pemesan']; ?>" onclick="return confirm('yakin hapus?')">Hapus</a>
                </td>
            </tr>
            </tr>
        <?php } ?>
